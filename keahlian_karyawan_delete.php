...
// Mengambil data keahlian_karyawan berdasarkan ID
if (isset($_GET['id'])) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE keahlian_karyawan SET id_karyawan='$id_karyawan', id_keahlian='$id_keahlian' WHERE id_keahlian_karyawan='$id_keahlian_karyawan'";
...
<form method="POST" style="text-align: center;">
    <table style="margin: 0 auto;">
        ...
        <tr>
            <td>ID Keahlian:</td>
            <td><input type="number" name="id_keahlian" value="<?php echo $row['id_keahlian']; ?>" required></td>
        </tr>
        <tr>
